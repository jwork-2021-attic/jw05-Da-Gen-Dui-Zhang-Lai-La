...
public class CreatureFactory {
    ...
    public Creature newPlayer(List<String> messages) {
        Player player = new Player(this.world, (char)2, Color.blue, 1000, 12, 12, 900,25);
